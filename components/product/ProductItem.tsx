      ...
      <div className="p-4">
        ...
        <div className="flex flex-col">
          ...
          <Link
            ...
            className="w-full text-center bg-linear-to-r from-red-500 to-orange-500 text-white py-2 rounded-full text-sm font-bold hover:brightness-110 transition-all"
          >
            GRAB IT NOW!
          </Link>
